    ...
    def write_out(self, fn: str = "", fmt: str = ""):
        ...
        if fn:
            try:
                ...
                raise e
            f.write("# RDF generated by CSV2RDF Converter.")
            f.write("\n")
            f.write(self.vocab_rdf.serialize(format=fmt))
            f.close()
        else:
            print("# RDF generated by CSV2RDF Converter.")
            print(self.vocab_rdf.serialize(format=fmt))
